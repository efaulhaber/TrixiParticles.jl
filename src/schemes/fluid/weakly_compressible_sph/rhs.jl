...
function interact!(
    ...
    foreach_point_neighbor(
        ...
        viscosity_correction, pressure_correction, surface_tension_correction = free_surface_correction(
            correction,
            particle_system,
            rho_mean
        )
        ...
        p_a, p_b = particle_neighbor_pressure(
        ...
        dv_pressure = pressure_correction *
            ...
            particle_system, neighbor_system, neighbor,
        ...
        dv_adhesion = adhesion_force(
            surface_tension, particle_system, neighbor_system,
            particle, neighbor, pos_diff, distance
        )
        ...
        continuity_equation!(
            dv, density_calculator, v_particle_system, v_neighbor_system,
...
@inline function continuity_equation!(
    ...
    density_diffusion!(
        dv, density_diffusion, v_particle_system, v_neighbor_system,
        particle, neighbor, pos_diff, distance, m_b, rho_a, rho_b,
        particle_system, neighbor_system, grad_kernel
    )
end
