...
@inline function interact_solid_solid!(
        dv, neighborhood_search, particle_system,
        neighbor_system
    )
    ...
    foreach_point_neighbor(
        ...
        neighborhood_search
    ) do particle, neighbor, initial_pos_diff,
            initial_distance
...
function interact!(
    ...
    foreach_point_neighbor(
        ...
        dv_boundary = pressure_acceleration(
            neighbor_system, particle_system, particle,
