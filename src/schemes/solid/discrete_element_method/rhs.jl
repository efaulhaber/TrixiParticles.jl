...
function interact!(
    ...
    foreach_point_neighbor(
        ...
        interaction_force = collision_force(
            particle_system, neighbor_system, overlap,
...
@inline function collision_force(
...
@inline function collision_force(
        particle_system, neighbor_system::DEMSystem, overlap,
...
@inline function position_correction!(
        neighbor_system::BoundaryDEMSystem, u_particle_system,
