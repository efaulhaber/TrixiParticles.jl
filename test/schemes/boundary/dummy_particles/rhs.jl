    ...
    @testset verbose = true "Momentum and Total Energy Conservation" begin
        ...
        @testset "`$(nameof(typeof(density_calculator)))`" for density_calculator in density_calculators
            ...
            for seed in 1:3
                ...
                # Create several neighbor systems to test fluid-neighbor interaction
                systems, vu = second_systems(
                    boundary, density_calculator,
                    state_equation,
                    smoothing_kernel, smoothing_length
                )

                nhs = TrixiParticles.TrivialNeighborhoodSearch{2}(;
                    search_radius,
                ...
                @testset "$key" for key in keys(systems)
                    ...
                    nhs2 = TrixiParticles.TrivialNeighborhoodSearch{2}(;
                        search_radius,
                    ...
                    TrixiParticles.interact!(
                        dv, v, u, v_neighbor, u_neighbor, nhs2,
